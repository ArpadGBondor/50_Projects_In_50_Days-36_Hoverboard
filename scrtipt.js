...
const colors = [
  ...
  colourNameToHex('red'),
  colourNameToHex('violet'),
  colourNameToHex('green'),
  colourNameToHex('blue'),
  colourNameToHex('orange'),
  colourNameToHex('purple'),
  colourNameToHex('white'),
];
const SQUARES = 500;
